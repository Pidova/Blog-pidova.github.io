...
printf("%d, %d\n", hello, hello);
```
![CFG Graph]({{ '/assets/files/decompilerconstruction/chapter4/graph.svg' | relative_url }})

[Download GraphViz Example]({{ '/assets/files/decompilerconstruction/chapter4/IR_Example.dot' | relative_url }})
