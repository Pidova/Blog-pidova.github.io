...
printf("%d, %d\n", hello, hello);
```
![CFG Graph](/blog/assets/files/decompilerconstruction/chapter4/graph.svg)

[Download GraphViz Example](/blog/assets/files/decompilerconstruction/chapter4/IR_Example.dot)
