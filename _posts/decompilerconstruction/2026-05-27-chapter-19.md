...
....
```
[Download Full Assembly]({{ '/assets/files/decompilerconstruction/chapter19/assembly.asm' | relative_url }})
...
.... 
```
[Download Full IL]({{ '/assets/files/decompilerconstruction/chapter19/IL.txt' | relative_url }})
...
....
```
[Download Full IR]({{ '/assets/files/decompilerconstruction/chapter19/IR.txt' | relative_url }})

Generated CFG:
![UNOPTCFG Graph]({{ '/assets/files/decompilerconstruction/chapter19/cfggraphviz1.svg' | relative_url }})

[Download GraphViz Example]({{ '/assets/files/decompilerconstruction/chapter19/cfggraphviz1.dot' | relative_url }})
