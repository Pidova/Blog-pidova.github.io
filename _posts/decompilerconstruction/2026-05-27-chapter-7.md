...
printf("%d, %d\n", hello, hello);
```
![CFG Graph](/blog/assets/files/decompilerconstruction/chapter7/IRgraph.svg)

[Download GraphViz Example](/blog/assets/files/decompilerconstruction/chapter7/IR_Example.dot)
