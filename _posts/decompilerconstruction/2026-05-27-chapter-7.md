...
printf("%d, %d\n", hello, hello);
```
![CFG Graph]({{ site.baseurl }}/blog/assets/files/decompilerconstruction/chapter7/IRgraph.svg)

[Download GraphViz Example]({{ site.baseurl }}/blog/assets/files/decompilerconstruction/chapter7/IR_Example.dot)
