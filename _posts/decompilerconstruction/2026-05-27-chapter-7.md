...
printf("%d, %d\n", hello, hello);
```
![CFG Graph]({{ '/assets/files/decompilerconstruction/chapter7/IRgraph.svg' | relative_url }})

[Download GraphViz Example]({{ '/assets/files/decompilerconstruction/chapter7/IR_Example.dot' | relative_url }})
